...
const HomeLayout = () => {
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: [0, 1] }} className="min-h-screen bg-white text-gray-800">
          ...
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <Link href="/" className="flex items-center">
                <Image src={'/icons/resume-icon.png'} alt="logo" height="32" width="32" className="mr-2" />
                <span className="font-bold text-xl text-resume-800 tracking-tight">ResumeBuilder</span>
              </Link>
              
              <div className="hidden md:ml-8 md:flex md:items-center md:space-x-6">
                <Link href="/builder" className="text-gray-700 hover:text-resume-700 font-medium text-sm transition-colors px-3 py-2 rounded-md hover:bg-gray-50">
                  Create Resume
        </Link>
                ...
                <div className="relative group">
                  ...
                  <div className="absolute left-0 mt-2 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 ease-in-out z-50">
                    <div className="py-1" role="menu" aria-orientation="vertical">
                      <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">Professional</a>
                      <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">Creative</a>
                      <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">Minimal</a>
                      <a href="#" className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">Academic</a>
                    </div>
                  </div>
                </div>
                
                <Link href="#features" className="text-gray-700 hover:text-resume-700 font-medium text-sm transition-colors px-3 py-2 rounded-md hover:bg-gray-50">
                  Features
            </Link>
                
                <Link href="#contribute" className="text-gray-700 hover:text-resume-700 font-medium text-sm transition-colors px-3 py-2 rounded-md hover:bg-gray-50">
                Contribute
            </Link>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              <div className="hidden md:block">
                <Link href="/builder" className="inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-resume-700 hover:bg-resume-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-resume-500 transition-colors">
                  Get Started
            </Link>
              </div>
          ...
          <motion.div
                ...
                >
                  ...
                  <p className="mt-4 text-base text-gray-600 sm:text-lg md:text-xl max-w-2xl">
                    Stand out from the crowd with a beautifully designed resume that highlights your skills and experience. Our easy-to-use builder makes it simple to create a stunning resume in just minutes.
                  </p>
      ...
      <section id="features" className="py-16 md:py-24 bg-white relative overflow-hidden">
        <div className="absolute inset-0 bg-gray-50 opacity-50 z-0">
          <svg className="absolute right-0 top-0 transform translate-x-1/2 -translate-y-1/4 lg:translate-x-1/4 xl:-translate-y-1/2" width="404" height="404" fill="none" viewBox="0 0 404 404" aria-hidden="true">
            <defs>
          ...
          <svg className="absolute bottom-0 left-0 transform -translate-x-1/2 translate-y-1/4 lg:-translate-x-1/4 xl:translate-y-1/2" width="404" height="404" fill="none" viewBox="0 0 404 404" aria-hidden="true">
            <defs>
              <pattern id="85737c0f-0916-41d7-917f-596dc7edfa27" x="0" y="0" width="20" height="20" patternUnits="userSpaceOnUse">
                <rect x="0" y="0" width="4" height="4" className="text-gray-200" fill="currentColor" />
              </pattern>
            </defs>
      ...
      <motion.div
              ...
              transition={{ duration: 0.5 }}
            >
              <h2 className="text-base text-resume-700 font-semibold tracking-wide uppercase">Features</h2>
              <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
                Everything you need to build a standout resume
              </p>
              <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
                Our intuitive resume builder provides all the tools you need to create a professional resume that gets noticed by employers.
              </p>
            </motion.div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center mb-16">
            <motion.div
              ...
              transition={{ duration: 0.5 }}
            >
              <h2 className="text-base text-resume-700 font-semibold tracking-wide uppercase">About Us</h2>
              <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
                The Team Behind ResumeBuilder
              </p>
              <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
                We're a passionate team of developers, designers, and career experts committed to helping job seekers create professional resumes.
              </p>
            </motion.div>
          </div>
          ...
          <div className="mt-10">
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
              ...
              >
                <div className="aspect-w-3 aspect-h-2 lg:aspect-none rounded-2xl overflow-hidden h-full">
                  <Image
                    src="https://images.unsplash.com/photo-1522071820081-009f0129c71c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80"
                    alt="Our team working together"
                    height={400}
                    width={600}
                    className="w-full h-full object-center object-cover lg:h-full lg:w-full rounded-2xl"
                    onError={(e) => {
                      // Fallback if image doesn't exist
                      e.currentTarget.src = "https://images.unsplash.com/photo-1522071820081-009f0129c71c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2070&q=80";
                    }}
                  />
                </div>
              </motion.div>
              ...
              >
                ...
                <p className="text-gray-600 mb-6">
                  Our mission is to empower job seekers with the tools they need to stand out in competitive job markets. We believe that everyone deserves access to professional resume-building tools, regardless of their design skills or technical abilities.
                </p>
                
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Our Approach</h3>
                <p className="text-gray-600 mb-6">
                  We've combined our expertise in design, technology, and career development to create an intuitive platform that makes resume creation simple and accessible. Our templates are professionally designed and optimized for Applicant Tracking Systems to maximize your chances of landing interviews.
                </p>
            ...
            <div>
              ...
              >
                ...
                <p className="mt-4 text-lg leading-6 text-resume-100">
                  No sign-up required. Just start building and download when you're done. Join thousands of job seekers who have successfully landed their dream jobs using our platform.
                </p>
                <div className="mt-8 flex flex-col sm:flex-row gap-4">
                  <Link href="/builder">
                    <Button
                  ...
                  <a href="#features" className="inline-flex items-center justify-center px-5 py-3 border border-white text-base font-medium rounded-md text-white hover:bg-resume-800 sm:px-8 transition-colors">
                    Learn More
                  </a>
                </div>
              </motion.div>
                ...
                <div className="flex flex-col space-y-6">
                  <div className="flex">
                    <div className="flex-shrink-0">
                      <svg className="h-6 w-6 text-resume-100" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className="ml-3">
                      ...
                      <p className="mt-1 text-sm text-white">Our templates are designed to pass through Applicant Tracking Systems.</p>
                    </div>
                  </div>
                  <div className="flex">
                    <div className="flex-shrink-0">
                    ...
                    <div className="ml-3">
                      ...
                      <p className="mt-1 text-sm text-white">See changes instantly as you build your professional resume.</p>
                    </div>
                  </div>
                  <div className="flex">
                    <div className="flex-shrink-0">
                    ...
                    <div className="ml-3">
                      ...
                      <p className="mt-1 text-sm text-white">Professional templates designed by career experts.</p>
                    </div>
                  </div>
                </div>
              </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center mb-16">
            <motion.div
              ...
              transition={{ duration: 0.5 }}
            >
              <h2 className="text-base text-resume-700 font-semibold tracking-wide uppercase">Open Source</h2>
              <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
                Contribute to the Project
              </p>
              <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
                This resume builder is an open-source project. Join our community and help make it even better!
              </p>
            </motion.div>
          </div>
        ...
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="md:col-span-1">
              <div className="flex items-center">
                <Image src={'/icons/resume-icon.png'} alt="logo" height="36" width="36" className="mr-2" />
              ...
              <div className="mt-4 flex space-x-4">
                <a href="https://github.com/AltafEmpaxis/resume-builder" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-white transition-colors">
                  <BsGithub className="h-5 w-5" />
                </a>
            ...
            <div>
              ...
              <ul className="mt-4 space-y-3">
                ...
                <li>
                  <a href="#contribute" className="text-sm text-gray-400 hover:text-white transition-colors">
                    Contribute
                  </a>
                </li>
                <li>
                  <a href="https://github.com/AltafEmpaxis/resume-builder" target="_blank" rel="noreferrer" className="text-sm text-gray-400 hover:text-white transition-colors">
                    GitHub
                  </a>
                </li>
                <li>
...
const ContributeCard = ({ icon, title, description }: { icon: string; title: string; description: string }) => {
  return (
    <motion.div
      whileHover={{ y: -5 }}
...
const ContributorCard = ({ name, role, avatar, github, linkedin, website }: { name: string; role: string; avatar: string; github: string; linkedin: string; website?: string }) => {
  return (
    <motion.div
      whileHover={{ y: -5 }}
